  ...
  return (
    ...
    <ScrollView contentContainerStyle={{paddingBottom : 20}} className="flex-1 bg-neutral-900">
        ...
        <Image
            ...
            style={{width : width * 0.6, height: height * 0.4 , borderRadius : 20 , shadowColor: "#000", shadowOffset: {width: 0, height: 2}, shadowOpacity: 0.25, shadowRadius: 3.84, marginBottom : 30}}
...

        {
              movie?.genres?.map((item , index) => {
                  return(
                    <View key={index} style={{backgroundColor :  '#96a723', borderRadius : 30 , padding : 7 }}>
